 ...
 *
 * Interface graphique permettant d'entrer une nouvelle commande pour un clien.
 */
public class NouvelleCommande extends JPanel {
    ...
    public NouvelleCommande(final Magasin m) {
       ...
       this.add(textArea);
//        textArea.append("Commande pour le client " + m.c.getNoclient() + "\n");
        ...
        ajouter.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                int no = Integer.parseInt(noArticle.getText());
